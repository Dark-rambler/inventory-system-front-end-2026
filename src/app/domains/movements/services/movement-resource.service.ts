...
export class MovementResourceService {
  private readonly _inventoryMovementService: InventoryMovementService =
  ...
  public readonly movementResource = rxResource({
    ...
    loader: ({ request }) => {
      ...
      return this._getMovement(request);
    },
  });
  ...
  private _getMovement(request: MovementParams): Observable<PaginatorInterface<Movement>> {
